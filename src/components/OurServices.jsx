    ...
    <div className="OurServicespage">
      ...
      <div className="Choose">
        <div className="Chooseone">
          ...
          >
            {[
              { title: "Urgent Shipments", text: "Send product samples with 3 to 5 day delivery." },
              { title: "Small parcel orders", text: "Ship lightweight eCommerce parcels with predictable tracking and delivery." },
